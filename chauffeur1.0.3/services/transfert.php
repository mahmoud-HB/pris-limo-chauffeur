			...
			<div class="wrap">
				<div class="section group">
					<div class="col span_1_of_3">
						...
						<div>
						<?php if ($data != "") {?>
							<p style="font-weight: bold;"><?php echo _f("Durée estimé pour votre trajet : ").round($data['duree'])."mn (".round($data['distance'])."km)";?></p>
							<?php }?>
							<br>
						</div>
						<div id="container">
					...
					<div class="col span_2_of_3">
						<div style="margin-left: 30px;">
							...
							<ul class="b">
								...
								<li>Départ de :&emsp; <?php echo $globDepart; ?></li>
								<li>Arrivée à :  &emsp; <?php echo $globArrivee; ?></li>
